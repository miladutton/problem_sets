...
ggplot(data = df.diamonds,
  ...
  geom_point()
=======
```{r height=6in, width=8in}
ggplot(data=df.diamonds, aes(x=depth, y=table))+
  geom_point(alpha=.05)

>>>>>>> 1985e1fe38322e07def8dab16b4233afd0e5fe02
```
...
ggplot(data=df.diamonds) +
  ...
  stat_summary(fun = "mean",
               geom = "bar",
               fill = 'lightblue') +
  scale_y_continuous(expand = c(0,0)) + # NOT NECESSARY JUST NICE
  stat_summary(fun.data = "mean_cl_boot",
               geom = "linerange")
